...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { city: @destination.city, latitude: @destination.latitude, longitude: @destination.longitude, state: @destination.state, street: @destination.street, zip_code: @destination.zip_code }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { city: @destination.city, latitude: @destination.latitude, longitude: @destination.longitude, state: @destination.state, street: @destination.street, zip_code: @destination.zip_code }
    assert_redirected_to destination_path(assigns(:destination))
  end
