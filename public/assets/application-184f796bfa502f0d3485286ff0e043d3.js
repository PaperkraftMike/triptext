...
(function() {
  $(document).ready(function() {
    ...
    $("#first").click(function() {
      return parallax.second.left();
    });
    return $("#second").click(function() {
      return parallax.first.right();
    });
  });
...
(function() {
  $(document).ready(function() {
    $("#first form").bind("ajax:complete", function(evt, xhr, status) {
      var errors;
      if (status === 'success') {
        ...
        if (errors.zip_code) {
          ...
          return $("#to_zip_error").fadeIn();
        } else {
          return $("#to_zip_error").fadeOut();
        }
      }
    });
    $("#second form").bind("ajax:complete", function(evt, xhr, status) {
      var errors;
      if (status === 'success') {
        ...
        $("#second").animate({
          ...
          return $("#second").css("display", "none");
        });
        return $("#third").animate({
          left: "50%"
        }, 500);
      } else {
        errors = $.parseJSON(xhr.responseText).errors;
        ...
        if (errors.zip_code) {
          ...
          return $("#from_zip_error").fadeIn();
        } else {
          return $("#from_zip_error").fadeOut();
        }
      }
    });
    return $("#third form").bind("ajax:complete", function(evt, xhr, status) {
      var errors;
      if (status === 'success') {
        ...
        return $("#from_phone_error").fadeIn();
      }
    });
  });
...
(function() {
  var directionsDisplay, directionsService, full_destination, geocoder_one_results, map;

  directionsDisplay = void 0;

  directionsService = void 0;

  full_destination = void 0;

  geocoder_one_results = void 0;
  ...
  $(document).ready(function() {
    var calcRoute, createMarker, getLatLong_destination, getLatLong_origin, infowindow, initialize;
    calcRoute = void 0;
    createMarker = void 0;
    getLatLong_destination = void 0;
    getLatLong_origin = void 0;
    infowindow = void 0;
    initialize = void 0;
    initialize = function() {
      var control, mapOptions;
      control = void 0;
      mapOptions = void 0;
      ...
      return map.controls[google.maps.ControlPosition.TOP_CENTER].push(control);
    };
    ...
    getLatLong_destination = function(address, callback) {
      var geo;
      geo = void 0;
      ...
      return geo.geocode({
        ...
        if (status === google.maps.GeocoderStatus.OK) {
          return callback(results, "Destination Pin", "Destination");
        }
      });
    };
    getLatLong_origin = function(address, callback) {
      var geo;
      geo = void 0;
      geo = new google.maps.Geocoder;
      return geo.geocode({
        ...
        if (status === google.maps.GeocoderStatus.OK) {
          return callback(results, "Origin Location Pin", "Origin Location");
        }
      });
    };
    ...
    $("#first form").bind("ajax:complete", function() {
      var d_street, d_zip_code;
      d_street = void 0;
      d_zip_code = void 0;
      d_street = $(".to_street input").val();
      d_zip_code = $(".to_zip_code input").val();
      full_destination = d_street + d_zip_code;
      return getLatLong_destination(full_destination, function(geocoder_one_results, pin_caption, pin_caption_two) {
        return createMarker(geocoder_one_results, pin_caption, pin_caption_two);
      });
    });
    $("#second form").bind("ajax:complete", function() {
      var c_street, c_zip_code, full_origin_location;
      c_street = void 0;
      c_zip_code = void 0;
      full_origin_location = void 0;
      c_street = $(".from_street input").val();
      c_zip_code = $(".from_zip_code input").val();
      full_origin_location = c_street + ", " + c_zip_code;
      getLatLong_origin(full_origin_location, function(geocoder_one_results, pin_caption, pin_caption_two) {
        return createMarker(geocoder_one_results, pin_caption, pin_caption_two);
      });
      return calcRoute(full_origin_location, full_destination);
    });
